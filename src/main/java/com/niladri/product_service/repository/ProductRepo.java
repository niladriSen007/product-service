...
public interface ProductRepo extends JpaRepository<Product, Long> {
    boolean existsByTitleAndCategory_Id(@NotBlank(message = "Title is required") @Size(min = 1, max = 50, message = "Title must be between 1 and 50 characters") String title, Long category_id);
